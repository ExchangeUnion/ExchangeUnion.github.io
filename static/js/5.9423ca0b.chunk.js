...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_custom_transition__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_scroll__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_utils__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_subscribe__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_loading__ = __webpack_require__(240);
...
var News = /** @class */ (function (_super) {
    ...
    News.prototype.componentDidMount = function () {
        var _this = this;
        var url = 'https://cdn-images-1.medium.com/max/800/1*3-dUp6DsQHa0VaA9K_e8Bg.jpeg';
    ...
    News.prototype.onFormantDate = function (date) {
        var oDate = new Date(date);
        return {
            year: oDate.getFullYear(),
            month: __WEBPACK_IMPORTED_MODULE_4__utils_utils__["a" /* Utils */].formantMonth(oDate.getMonth()),
            day: oDate.getDate()
        };
    };
    News.prototype.render = function () {
        var _this = this;
        var _a = this.props, i18n = _a.i18n, lang = _a.lang, lastBlogPost = _a.lastBlogPost, lastPressPost = _a.lastPressPost, blogLoading = _a.blogLoading, pressLoading = _a.pressLoading;
        var isAcc = this.state.isAcc;
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.news },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.header },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.content },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3__components_scroll__["a" /* default */], null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__components_custom_transition__["a" /* default */], null,
                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.title },
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", { className: style.titleText }, i18n.NEWS_PAGE_TITLE),
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.subscribe },
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h4", null, i18n.NEWS_LETTER_FOOTER_TEXT),
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__components_subscribe__["a" /* default */], { i18n: i18n, lang: lang }))))))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.blog + " " + style.parts },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.content },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", { className: style.title }, i18n.NEWS_PAGE_BLOG_TITLE),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: isAcc ? style.flexbox + " " + style.isAcc : style.flexbox }, blogLoading ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_6__components_loading__["a" /* default */], { text: i18n.NEWS_PAGE_LOADING }) :
                        lastBlogPost.map(function (val) {
                            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dl", { key: val.id },
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: val.link, target: "_blank" },
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dt", { style: { backgroundImage: "url(" + (isAcc ? val.imageUrl : loading) + ")" } })),
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dd", null,
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: val.link, target: "_blank" },
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", { className: style.subtitle }, val.title),
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, val.body)),
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: val.authorLink, target: "_blank" },
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.userInfo },
                                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { src: isAcc ? val.photo : null, alt: "" }),
                                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null,
                                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, val.author),
                                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, new Date(val.postDate).toLocaleDateString()))))));
                        })),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.seeAll },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "https://blog.exchangeunion.com", target: "_blank" }, i18n.NEWS_PAGE_BLOG_PART1_SEEALL)))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.press + " " + style.parts },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.content },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", { className: style.title }, i18n.NEWS_PAGE_PRESS_TITLE),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.flexbox }, pressLoading ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_6__components_loading__["a" /* default */], { text: i18n.NEWS_PAGE_LOADING }) :
                        lastPressPost.map(function (item) {
                            var oDate = _this.onFormantDate(item.date);
                            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dl", { key: item.id },
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: item.link, target: "__blank" },
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dt", { style: { backgroundImage: "url(" + __WEBPACK_IMPORTED_MODULE_1__utils_config__["a" /* default */].IMAGE_URL + item.imageUrl + ")" } }),
                                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("dd", null,
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.dateInfo },
                                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.date },
                                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, oDate.day),
                                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, oDate.month)),
                                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null,
                                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("i", null, oDate.year))),
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, item.title),
                                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: style.source },
                                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", null, item.source)))));
                        }))))));
    };
    return News;
