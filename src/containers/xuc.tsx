        ...
        return (
            <div className={style.xuc}>
                        ...
                        <div className={style.svg}>
                            <div>
                                <div className={style.subtitle}>
                                    <span>{i18n.XUC_PAGE_PART1_DESCRIPTION}</span>
                                    <ul>
                                        <li>{i18n.XUC_PAGE_PART1_DESCRIPTION_ROLE1}</li>
                                        <li>{i18n.XUC_PAGE_PART1_DESCRIPTION_ROLE2}</li>
                                        <li>{i18n.XUC_PAGE_PART1_DESCRIPTION_ROLE3}</li>
                                        <li>
                                            <span>{i18n.XUC_PAGE_PART1_Functionaries}</span>
                                            <ul>
                                                <li>{i18n.XUC_PAGE_PART1_Functionaries_PART1}</li>
                                                <li>{i18n.XUC_PAGE_PART1_Functionaries_PART2}</li>
                                                <li>{i18n.XUC_PAGE_PART1_Functionaries_PART3}</li>                                   
                                            </ul>
                                        </li>                                   
                                    </ul>
                                </div>
                ...
                <div className={style.overview} style={{backgroundColor: '#f7f7f7'}}>
                    ...
                    <div className={style.content}>
                        {lang === 'zh-CN' ? <p className={style.call}>{i18n.XUC_PAGE_PART3_PHONE}</p> : null}
                    </div>
                </div>
            </div>
        );
